...
$c_Ltutorial_webapp_TutorialApp$.prototype.curvatureNextCircle__D__D__D__D = (function(c1, c2, c3) {
  var a = (((c1 * c2) + (c1 * c3)) + (c2 * c3));
  return (((c1 + c2) + c3) + (2 * $uD($g.Math.sqrt(a))))
});
$c_Ltutorial_webapp_TutorialApp$.prototype.main__V = (function() {
  var x1 = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("canvas");
  var cvs = ($uZ((x1 instanceof $g.HTMLCanvasElement)) ? new $c_s_Some().init___O(x1) : $m_s_None$());
  if (cvs.isEmpty__Z()) {
    var this$1 = $m_s_None$()
  } else {
    var arg1 = cvs.get__O();
    var this$1 = new $c_s_Some().init___O(arg1.getContext("2d"))
  };
  if (this$1.isEmpty__Z()) {
    throw new $c_jl_Error().init___()
  };
  var ctx = this$1.get__O();
  var c1 = new $c_Ltutorial_webapp_Circle().init___D__Ltutorial_webapp_Vector(250.0, new $c_Ltutorial_webapp_Vector().init___D__D(250, 250).$$plus__D__Ltutorial_webapp_Vector(250.0));
  var c2 = new $c_Ltutorial_webapp_Circle().init___D__Ltutorial_webapp_Vector(125.0, new $c_Ltutorial_webapp_Vector().init___D__D(125, 250).$$plus__D__Ltutorial_webapp_Vector(250.0));
  var c3 = new $c_Ltutorial_webapp_Circle().init___D__Ltutorial_webapp_Vector(125.0, new $c_Ltutorial_webapp_Vector().init___D__D(375, 250).$$plus__D__Ltutorial_webapp_Vector(250.0));
  c1.draw__T__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V("black", ctx);
  c2.draw__T__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V("black", ctx);
  c3.draw__T__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V("black", ctx);
  var this$2 = this.kissingCircles__Ltutorial_webapp_Circle__Ltutorial_webapp_Circle__Ltutorial_webapp_Circle__sci_List(c1, c2, c3);
  var c4 = $as_Ltutorial_webapp_Circle($f_sc_LinearSeqOptimized__apply__I__O(this$2, 0));
  c4.draw__T__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V("black", ctx)
});
$c_Ltutorial_webapp_TutorialApp$.prototype.kissingCircles__Ltutorial_webapp_Circle__Ltutorial_webapp_Circle__Ltutorial_webapp_Circle__sci_List = (function(c1, c2, c3) {
  var curvature = this.curvatureNextCircle__D__D__D__D(c1.bend__Ltutorial_webapp_Vector__D(c2.pos$1), c2.bend__Ltutorial_webapp_Vector__D(c1.pos$1), c3.bend__Ltutorial_webapp_Vector__D(c2.pos$1));
  var v = c1.pos$1;
  var jsx$2 = new $c_Ltutorial_webapp_Complex().init___D__D(v.x$1, v.y$1);
  var v$1 = c2.pos$1;
  var jsx$1 = new $c_Ltutorial_webapp_Complex().init___D__D(v$1.x$1, v$1.y$1);
  var v$2 = c3.pos$1;
  var this$2 = this.positionsNextCircle__Ltutorial_webapp_Complex__Ltutorial_webapp_Complex__Ltutorial_webapp_Complex__D__D__D__sci_List(jsx$2, jsx$1, new $c_Ltutorial_webapp_Complex().init___D__D(v$2.x$1, v$2.y$1), c1.bend__Ltutorial_webapp_Vector__D(c2.pos$1), c2.bend__Ltutorial_webapp_Vector__D(c1.pos$1), c3.bend__Ltutorial_webapp_Vector__D(c2.pos$1));
  var f = (function($this, curvature$1) {
    return (function(c$2) {
      var c = $as_Ltutorial_webapp_Complex(c$2);
      return new $c_Ltutorial_webapp_Vector().init___D__D((c.x$1 / curvature$1), (c.y$1 / curvature$1))
    })
  })(this, curvature);
  ...
  var this$6 = $as_sci_List(jsx$3);
  var f$1 = (function(this$2$1, curvature$2) {
    return (function(x$1$2) {
      var x$1 = $as_Ltutorial_webapp_Vector(x$1$2);
      return new $c_Ltutorial_webapp_Circle().init___D__Ltutorial_webapp_Vector((1 / curvature$2), x$1)
    })
  })(this, curvature);
...
$c_Ltutorial_webapp_TutorialApp$.prototype.positionsNextCircle__Ltutorial_webapp_Complex__Ltutorial_webapp_Complex__Ltutorial_webapp_Complex__D__D__D__sci_List = (function(z1, z2, z3, k1, k2, k3) {
  var bz1 = z1.$$times__D__Ltutorial_webapp_Complex(k1);
  var bz2 = z2.$$times__D__Ltutorial_webapp_Complex(k2);
  var bz3 = z3.$$times__D__Ltutorial_webapp_Complex(k3);
  var x = new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["z3 = ", ", k3 = ", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([z3, k3]));
  var this$2 = $m_s_Console$();
  var this$3 = $as_Ljava_io_PrintStream(this$2.outVar$2.v$1);
  this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V((x + "\n"));
  var x$1 = new $c_T3().init___O__O__O(bz1, bz2, bz3);
  ...
  var addition = bz1.$$plus__Ltutorial_webapp_Complex__Ltutorial_webapp_Complex(bz2).$$plus__Ltutorial_webapp_Complex__Ltutorial_webapp_Complex(bz3);
  var root = $m_Ltutorial_webapp_Complex$().sqrt__Ltutorial_webapp_Complex__Ltutorial_webapp_Complex(bz1.$$times__Ltutorial_webapp_Complex__Ltutorial_webapp_Complex(bz2).$$plus__Ltutorial_webapp_Complex__Ltutorial_webapp_Complex(bz1.$$times__Ltutorial_webapp_Complex__Ltutorial_webapp_Complex(bz3)).$$plus__Ltutorial_webapp_Complex__Ltutorial_webapp_Complex(bz2.$$times__Ltutorial_webapp_Complex__Ltutorial_webapp_Complex(bz3))).$$times__D__Ltutorial_webapp_Complex(2.0);
  $m_sci_List$();
  var xs = new $c_sjs_js_WrappedArray().init___sjs_js_Array([addition.$$minus__Ltutorial_webapp_Complex__Ltutorial_webapp_Complex(root), addition.$$plus__Ltutorial_webapp_Complex__Ltutorial_webapp_Complex(root)]);
...
/** @constructor */
function $c_Ltutorial_webapp_Complex$() {
  $c_O.call(this)
}
$c_Ltutorial_webapp_Complex$.prototype = new $h_O();
$c_Ltutorial_webapp_Complex$.prototype.constructor = $c_Ltutorial_webapp_Complex$;
/** @constructor */
function $h_Ltutorial_webapp_Complex$() {
  /*<skip>*/
}
$h_Ltutorial_webapp_Complex$.prototype = $c_Ltutorial_webapp_Complex$.prototype;
$c_Ltutorial_webapp_Complex$.prototype.init___ = (function() {
  return this
});
$c_Ltutorial_webapp_Complex$.prototype.sqrt__Ltutorial_webapp_Complex__Ltutorial_webapp_Complex = (function(c) {
  var r = c.modulus__D();
  var modZR = c.$$plus__D__Ltutorial_webapp_Complex(r).modulus__D();
  return c.$$plus__D__Ltutorial_webapp_Complex(r).$$div__D__Ltutorial_webapp_Complex(modZR).$$times__D__Ltutorial_webapp_Complex($uD($g.Math.sqrt(r)))
});
var $d_Ltutorial_webapp_Complex$ = new $TypeData().initClass({
  Ltutorial_webapp_Complex$: 0
}, false, "tutorial.webapp.Complex$", {
  Ltutorial_webapp_Complex$: 1,
  O: 1,
  s_Serializable: 1,
  Ljava_io_Serializable: 1
});
$c_Ltutorial_webapp_Complex$.prototype.$classData = $d_Ltutorial_webapp_Complex$;
var $n_Ltutorial_webapp_Complex$ = (void 0);
function $m_Ltutorial_webapp_Complex$() {
  if ((!$n_Ltutorial_webapp_Complex$)) {
    $n_Ltutorial_webapp_Complex$ = new $c_Ltutorial_webapp_Complex$().init___()
  };
  return $n_Ltutorial_webapp_Complex$
}
...
$c_jl_Error.prototype.init___ = (function() {
...
$c_sjsr_RuntimeLong.prototype.$classData = $d_sjsr_RuntimeLong;
/** @constructor */
function $c_Ltutorial_webapp_Circle() {
  $c_O.call(this);
  this.radius$1 = 0.0;
  this.pos$1 = null;
  this.curvature$1 = 0.0
}
$c_Ltutorial_webapp_Circle.prototype = new $h_O();
$c_Ltutorial_webapp_Circle.prototype.constructor = $c_Ltutorial_webapp_Circle;
/** @constructor */
function $h_Ltutorial_webapp_Circle() {
  /*<skip>*/
}
$h_Ltutorial_webapp_Circle.prototype = $c_Ltutorial_webapp_Circle.prototype;
$c_Ltutorial_webapp_Circle.prototype.productPrefix__T = (function() {
  return "Circle"
});
$c_Ltutorial_webapp_Circle.prototype.productArity__I = (function() {
  return 2
});
$c_Ltutorial_webapp_Circle.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Ltutorial_webapp_Circle(x$1)) {
    var Circle$1 = $as_Ltutorial_webapp_Circle(x$1);
    if ((this.radius$1 === Circle$1.radius$1)) {
      var x = this.pos$1;
      var x$2 = Circle$1.pos$1;
...
$c_Ltutorial_webapp_Circle.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
...
$c_Ltutorial_webapp_Circle.prototype.bend__Ltutorial_webapp_Vector__D = (function(p) {
  return ((p.$$minus__Ltutorial_webapp_Vector__Ltutorial_webapp_Vector(this.pos$1).magnitude__D() < this.radius$1) ? (-this.curvature$1) : this.curvature$1)
});
$c_Ltutorial_webapp_Circle.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Ltutorial_webapp_Circle.prototype.draw__T__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V = (function(color, ctx) {
  ctx.beginPath();
  ctx.strokeStyle = color;
  ctx.arc(this.pos$1.x$1, this.pos$1.y$1, this.radius$1, 6.283185307179586, 0.0);
  ctx.stroke()
});
$c_Ltutorial_webapp_Circle.prototype.hashCode__I = (function() {
  var acc = (-889275714);
...
$c_Ltutorial_webapp_Circle.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
$c_Ltutorial_webapp_Circle.prototype.init___D__Ltutorial_webapp_Vector = (function(radius, pos) {
  this.radius$1 = radius;
  this.pos$1 = pos;
  this.curvature$1 = (1.0 / radius);
  return this
});
function $is_Ltutorial_webapp_Circle(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Ltutorial_webapp_Circle)))
}
function $as_Ltutorial_webapp_Circle(obj) {
  return (($is_Ltutorial_webapp_Circle(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "tutorial.webapp.Circle"))
}
function $isArrayOf_Ltutorial_webapp_Circle(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Ltutorial_webapp_Circle)))
}
function $asArrayOf_Ltutorial_webapp_Circle(obj, depth) {
  return (($isArrayOf_Ltutorial_webapp_Circle(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Ltutorial.webapp.Circle;", depth))
}
var $d_Ltutorial_webapp_Circle = new $TypeData().initClass({
  Ltutorial_webapp_Circle: 0
}, false, "tutorial.webapp.Circle", {
  Ltutorial_webapp_Circle: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Ltutorial_webapp_Circle.prototype.$classData = $d_Ltutorial_webapp_Circle;
/** @constructor */
function $c_Ltutorial_webapp_Complex() {
  $c_O.call(this);
  this.x$1 = 0.0;
...
$h_Ltutorial_webapp_Complex.prototype = $c_Ltutorial_webapp_Complex.prototype;
$c_Ltutorial_webapp_Complex.prototype.productPrefix__T = (function() {
  return "Complex"
});
$c_Ltutorial_webapp_Complex.prototype.productArity__I = (function() {
  return 2
});
$c_Ltutorial_webapp_Complex.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Ltutorial_webapp_Complex(x$1)) {
    var Complex$1 = $as_Ltutorial_webapp_Complex(x$1);
    return ((this.x$1 === Complex$1.x$1) && (this.y$1 === Complex$1.y$1))
  } else {
    return false
  }
});
$c_Ltutorial_webapp_Complex.prototype.modulus__D = (function() {
  var a = ((this.x$1 * this.x$1) + (this.y$1 * this.y$1));
  return $uD($g.Math.sqrt(a))
});
$c_Ltutorial_webapp_Complex.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.x$1;
      break
...
$c_Ltutorial_webapp_Complex.prototype.$$plus__D__Ltutorial_webapp_Complex = (function(d) {
  return new $c_Ltutorial_webapp_Complex().init___D__D((this.x$1 + d), this.y$1)
});
$c_Ltutorial_webapp_Complex.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Ltutorial_webapp_Complex.prototype.$$minus__Ltutorial_webapp_Complex__Ltutorial_webapp_Complex = (function(o) {
  return new $c_Ltutorial_webapp_Complex().init___D__D((this.x$1 - o.x$1), (this.y$1 - o.y$1))
});
$c_Ltutorial_webapp_Complex.prototype.init___D__D = (function(x, y) {
  this.x$1 = x;
  this.y$1 = y;
  return this
});
$c_Ltutorial_webapp_Complex.prototype.$$times__D__Ltutorial_webapp_Complex = (function(d) {
  return new $c_Ltutorial_webapp_Complex().init___D__D((this.x$1 * d), (this.y$1 * d))
});
$c_Ltutorial_webapp_Complex.prototype.$$div__D__Ltutorial_webapp_Complex = (function(d) {
  return new $c_Ltutorial_webapp_Complex().init___D__D((this.x$1 / d), (this.y$1 / d))
});
$c_Ltutorial_webapp_Complex.prototype.$$times__Ltutorial_webapp_Complex__Ltutorial_webapp_Complex = (function(o) {
  return new $c_Ltutorial_webapp_Complex().init___D__D(((this.x$1 * o.x$1) - (this.y$1 * o.y$1)), ((this.x$1 * o.y$1) + (this.y$1 * o.x$1)))
});
$c_Ltutorial_webapp_Complex.prototype.hashCode__I = (function() {
  var acc = (-889275714);
...
$c_Ltutorial_webapp_Complex.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
$c_Ltutorial_webapp_Complex.prototype.$$plus__Ltutorial_webapp_Complex__Ltutorial_webapp_Complex = (function(o) {
  return new $c_Ltutorial_webapp_Complex().init___D__D((this.x$1 + o.x$1), (this.y$1 + o.y$1))
});
function $is_Ltutorial_webapp_Complex(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Ltutorial_webapp_Complex)))
}
function $as_Ltutorial_webapp_Complex(obj) {
  return (($is_Ltutorial_webapp_Complex(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "tutorial.webapp.Complex"))
}
function $isArrayOf_Ltutorial_webapp_Complex(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Ltutorial_webapp_Complex)))
}
function $asArrayOf_Ltutorial_webapp_Complex(obj, depth) {
  return (($isArrayOf_Ltutorial_webapp_Complex(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Ltutorial.webapp.Complex;", depth))
}
var $d_Ltutorial_webapp_Complex = new $TypeData().initClass({
  Ltutorial_webapp_Complex: 0
}, false, "tutorial.webapp.Complex", {
...
$c_Ltutorial_webapp_Complex.prototype.$classData = $d_Ltutorial_webapp_Complex;
/** @constructor */
function $c_Ltutorial_webapp_Vector() {
  $c_O.call(this);
  this.x$1 = 0.0;
  this.y$1 = 0.0
}
$c_Ltutorial_webapp_Vector.prototype = new $h_O();
$c_Ltutorial_webapp_Vector.prototype.constructor = $c_Ltutorial_webapp_Vector;
/** @constructor */
function $h_Ltutorial_webapp_Vector() {
  /*<skip>*/
}
$h_Ltutorial_webapp_Vector.prototype = $c_Ltutorial_webapp_Vector.prototype;
$c_Ltutorial_webapp_Vector.prototype.productPrefix__T = (function() {
  return "Vector"
});
$c_Ltutorial_webapp_Vector.prototype.productArity__I = (function() {
  return 2
});
$c_Ltutorial_webapp_Vector.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Ltutorial_webapp_Vector(x$1)) {
    var Vector$1 = $as_Ltutorial_webapp_Vector(x$1);
    return ((this.x$1 === Vector$1.x$1) && (this.y$1 === Vector$1.y$1))
  } else {
    return false
  }
});
$c_Ltutorial_webapp_Vector.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.x$1;
      break
...
$c_Ltutorial_webapp_Vector.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Ltutorial_webapp_Vector.prototype.init___D__D = (function(x, y) {
  this.x$1 = x;
  this.y$1 = y;
  return this
});
$c_Ltutorial_webapp_Vector.prototype.$$plus__D__Ltutorial_webapp_Vector = (function(d) {
  return new $c_Ltutorial_webapp_Vector().init___D__D((this.x$1 + d), (this.y$1 + d))
});
$c_Ltutorial_webapp_Vector.prototype.magnitude__D = (function() {
  var a = ((this.x$1 * this.x$1) + (this.y$1 * this.y$1));
  return $uD($g.Math.sqrt(a))
});
$c_Ltutorial_webapp_Vector.prototype.$$minus__Ltutorial_webapp_Vector__Ltutorial_webapp_Vector = (function(v) {
  return new $c_Ltutorial_webapp_Vector().init___D__D((this.x$1 - v.x$1), (this.y$1 - v.y$1))
});
$c_Ltutorial_webapp_Vector.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().doubleHash__D__I(this.x$1));
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().doubleHash__D__I(this.y$1));
  return $m_sr_Statics$().finalizeHash__I__I__I(acc, 2)
});
$c_Ltutorial_webapp_Vector.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Ltutorial_webapp_Vector(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Ltutorial_webapp_Vector)))
}
function $as_Ltutorial_webapp_Vector(obj) {
  return (($is_Ltutorial_webapp_Vector(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "tutorial.webapp.Vector"))
}
function $isArrayOf_Ltutorial_webapp_Vector(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Ltutorial_webapp_Vector)))
}
function $asArrayOf_Ltutorial_webapp_Vector(obj, depth) {
  return (($isArrayOf_Ltutorial_webapp_Vector(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Ltutorial.webapp.Vector;", depth))
}
var $d_Ltutorial_webapp_Vector = new $TypeData().initClass({
  Ltutorial_webapp_Vector: 0
}, false, "tutorial.webapp.Vector", {
  Ltutorial_webapp_Vector: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Ltutorial_webapp_Vector.prototype.$classData = $d_Ltutorial_webapp_Vector;
/** @constructor */
